...
def images_to_video(image_folder, output_path, fps):
    images_files = os.load(r'/Users/ironieser/Documents/shanghaitech/project/llm4video/data/video/fUjz_eiIX8k/filelist.txt')
    ...
    return output_path
# 设置输入图像文件夹、输出视频路径和帧率
input_folder = '/Users/ironieser/Documents/shanghaitech/project/llm4video/data/video/fUjz_eiIX8k'  # 输入图像文件夹路径
output_video = '/Users/ironieser/Documents/shanghaitech/project/llm4video/data/test.mp4'  # 输出视频路径
frame_rate = 25  # 视频帧率
...
# video_without_audio = video.set_audio(audio)
